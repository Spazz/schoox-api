module.exports = function(schoox){
    return {
        ...
        getCurriculumStudents: function (curriculumId, options, callback) {
            ...
            schoox._get(`curriculums/${curriculumId}/students`, req, function (error, body) {
                callback(error, body);
            });
        },
        //#endregion
        ...
        completeCurriculumByAdmin: function (curriculumId, users, options, callback) {
            ...
            schoox._put(`curriculums/${curriculumId}/completeByAdmin`, req, users, function (error, body) {
                callback(error, body);
            });
        }
