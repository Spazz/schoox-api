module.exports = function(schoox){
    return {
        ...
        getCourseCouponEnrolledUsers: function (courseId, couponId, callback) {
            ...
            schoox._get(`courses/${courseId}/coupons/${couponId}`, req, function (error, body) {
                callback(error, body);
            });
        },
        //#endregion
        ...
        getCourseInvitations: function (courseId, callback) {
            ...
            schoox._get(`courses/${courseId}/invitations`, req, function (error, body) {
            callback(error, body);
            });
        },
        //#endregion
        ...
        completeCourseByAdmin: function (courseId, options, requestObject, callback) {
            ...
            schoox._put(`courses/${courseId}/completeByAdmin`, req, requestObj, function (error, body) {
                callback(error, body);
            });
        },
        //#endregion
        ...
        issueCustomCertificate: function (courseId, requestObject, callback) {
            ...
            schoox._put(`courses/${courseId}/issueCustomCertificate`, req, requestObj, function (error, body) {
            callback(error, body);
            });
        },
        //#endregion
